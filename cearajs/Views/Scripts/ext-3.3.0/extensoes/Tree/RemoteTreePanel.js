/*
 * PARA DESABILITAR A EDIÇÃO DE NÓS DA ÁRVORE É PRECISO DESABILITAR TAMBÉM O MENU DE CONTEXTO!!!!!!!!!!!!!!!
 * ...OU VOCÊ QUEIMARÁ NO MÁRMORE DO INFERNO!
 */
 ...
 * @version   1.0
 * @revision  $Id: Ext.ux.tree.RemoteTreePanel.js 649 2009-03-25 02:27:39Z jozo $
 *
...
Ext.ux.tree.RemoteTreePanel = Ext.extend(Ext.tree.TreePanel, {
	...
	// localizable texts
	 appendText:'Inserir'
	,collapseAllText:'Contrair Todas'
	,collapseText:'Contrair'
	,contextMenu:true
	,deleteText:'Delete'
	,errorText:'Erro'
	,expandAllText:'Expandir Todas'
	,expandText:'Expandir'
	,insertText:'Inserir'
	,newText:'Nova'
	,reallyWantText:'Você deseja realmente'
